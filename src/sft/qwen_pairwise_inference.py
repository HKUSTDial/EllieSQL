...
from .qwen_pairwise_sft import QwenForPairwiseRank
...
class QwenPairwiseClassifier:
    """Qwen pairwise classifier for classification inference"""
    ...
    def _load_model_and_tokenizer(self):
        ...
        # NOTE: Load the classifier head from the manually saved classifier.pt, ensure the same classifier head is used for training and inference
...
def test():
    ...
    classifier = QwenPairwiseClassifier(
        lora_path="/data/zhuyizhang/saves/Qwen2.5-0.5B-router/pairwise/final_model_classifier",
        seed=42
    )
