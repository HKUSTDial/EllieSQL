...
class ClassifierDataProcessor:
    """Process the labeled data to generate the SFT dataset (for the classification task with a classification head)"""
    ...
    def prepare_data(self, labeled_file: str, train_ratio: float = 0.8):
        """Prepare the training and validation data for the classification model"""
        # Load the data
        data = load_jsonl(labeled_file)
        
        # Construct the classification samples
        samples = []
