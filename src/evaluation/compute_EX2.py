...
if __name__ == "__main__":
    ...
    result_path = "./results\intermediate_results/20250207_125613"
    print("结果1：4o bird dev v")
    compute_EX_source_difficulty_based(merge_dev_demo_file, result_path)


    result_path = "./results\intermediate_results/20250207_125809"
    print("结果2：4o bird dev dcr")
    compute_EX_source_difficulty_based(merge_dev_demo_file, result_path)

    result_path = "./results\intermediate_results/20250207_131922"
    print("结果3：4o bird dev osr")
    compute_EX_source_difficulty_based(merge_dev_demo_file, result_path)


    result_path = "./results\intermediate_results/20250207_142411"
    print("结果4：4o bird dev dcosr")
    compute_EX_source_difficulty_based(merge_dev_demo_file, result_path)


    # result_path = "./results/intermediate_results/20250207_005637"
    # print("结果1：spider dev vanilla")
    # compute_EX_source_difficulty_based(merge_dev_demo_file, result_path)
