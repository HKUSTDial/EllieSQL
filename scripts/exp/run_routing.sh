...
# TEST_FILE="./data/formatted_spider_dev.json"
# TEST_FILE="./data/formatted_spider_realistic.json"
# TEST_FILE="./data/formatted_spider_syn.json"
MAX_WORKERS=64
# BACKBONE="gpt-3.5-turbo"
# BACKBONE="gpt-4o-mini-2024-07-18"
BACKBONE="gpt-4"
...
# python -m src.run_routing \
#     --router roberta \
#     --router_path "/data/zhuyizhang/ElephantSQL_Checkpoints/roberta_classification_sft/final_model_roberta_lora" \
#     --test_file $TEST_FILE \
#     --max_workers $MAX_WORKERS \
#     --backbone_model $BACKBONE
...
# python -m src.run_routing \
#     --router qwen_cascade \
#     --router_path "/data/zhuyizhang/ElephantSQL_Checkpoints/qwen_cascade_sft" \
...
#     --router_path "/data/zhuyizhang/ElephantSQL_Checkpoints/roberta_cascade_sft" \
#     --confidence_threshold 0.6 \
#     --test_file $TEST_FILE \
#     --max_workers $MAX_WORKERS \
#     --backbone_model $BACKBONE
...
#     --router_path "/data/zhuyizhang/ElephantSQL_Checkpoints/qwen_pairwise_sft/final_model_classifier" \
#     --test_file $TEST_FILE \
#     --max_workers $MAX_WORKERS \
#     --backbone_model $BACKBONE
