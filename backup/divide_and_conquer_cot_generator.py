...
import re
from online_synthesis_cot_generator import OnlineSynthesis

class DivideAndConquerSQLGenerator(SQLGeneratorBase):
    """使用Divide And Conquer CoT生成SQL的实现"""
    ...
    def __init__(self, 
                ...
                max_tokens: int = 5000):
        super().__init__("DivideAndConquerSQLGenerator")
        self.llm = llm
        self.model = model
